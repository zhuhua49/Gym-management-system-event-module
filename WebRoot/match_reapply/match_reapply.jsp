...
<body>
	  ...
	  <s:form action="match_reapply">
	      ...
	      <td rowspan="2"><label for="reviewer">上次审核人：</label></td>
	      ...
	      <tr>
	      <td><label for="result">上次未通过原因：</label></td>
		  <td colspan="5"><s:textarea name="match.result" value="%{#One.result}" readonly="true" id="result" cols="92" cssStyle="resize:none"/></td>
	      </tr>
...
<script src="${pageContext.request.contextPath}/match_reapply/match_reapply.js"></script>
</html>