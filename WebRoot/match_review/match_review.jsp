...
<body>
	  <div class="center">
	  <s:form action="match_review" name="match_review">
	      ...
	      <td rowspan="2"><s:textfield name="match.reviewer" value="%{#session.realname}" readonly="true" id="reviewer"/></td>
	      </tr>
	      ...
	      <tr>
	      <td><label for="state">审核结果：</label></td>
	      <td><s:select name="match.state" list="{'已通过','未通过'}" id="state" cssStyle="width:165px"/></td>
	      <td><label for="result">审核意见：</label></td>
		  <td colspan="3"><s:textarea name="match.result" value="若未通过，请写明未通过的原因" id="result" cols="58" cssStyle="resize:none"/></td>
	      </tr>
...
<script src="${pageContext.request.contextPath}/match_review/match_review.js"></script>
</html>